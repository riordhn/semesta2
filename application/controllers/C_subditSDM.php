...
class C_subditSDM extends CI_Controller
{
    ...
    public function uploadfile_SP($id = null)
    {
    ...
    public function uploadfile_SKP($id = null)
    {
    ...
    public function uploadfile_SKIB($id = null)
    {
    ...
    public function uploadfile_SPP($id = null)
    {
        $this->load->model('M_Perpanjangan_Subdit');
    ...
    //SpTB
    public function uploadfile_SPPSPTB($id = null)
    {
        $this->load->model('M_Perpanjangan_Subdit');
        $model = $this->M_Perpanjangan_Subdit;
        //$idjenis=$this->M_file_upload->getJenis();
    ...
    public function uploadfile_SKPP($id = null)
    {
        $this->load->model('M_Perpanjangan_Subdit');
        $model = $this->M_Perpanjangan_Subdit;
        //$idjenis=$this->M_file_upload->getJenis();
    ...
    public function uploadfile_SKPK($id = null)
    {
        $this->load->model('M_Pengaktifan_Subdit');
