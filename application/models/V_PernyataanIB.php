...
$document = file_get_contents("file/template/Ibel/SURAT PERNYATAAN.rtf");
...
header("Content-disposition: inline; filename=Surat Pernyataan Bermaterai(3)_".$nik."_".$id_tub.".doc");
