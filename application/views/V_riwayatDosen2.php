    ...
    <div class="container-fluid">
       <div class="box">
                <div class="box-header">
                  <center><h3 class="box-title">Riwayat Usulan Izin Belajar</h3></center> <br>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        echo $data->STATUS_SL;}
                        ?></td>
                        <td align="center"><a href="<?php echo base_url().'C_dosen/detailIbel/'.$data->ID_IB;?>"><button class="btn btn-primary btn-xs">Lihat Detail</button></a></td>
                        <td><a href="<?php echo base_url().'C_dosen/unduhDosen2/'.$data->ID_IB;?>">Lihat/Unduh</a></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                  </table>
              ...
              <div class="box-header">
                  <center><h3 class="box-title">Riwayat Usulan Pengaktifan Kembali dari Izin Belajar</h3></center> <br>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    <thead>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="center"><a href="<?php echo base_url().'C_dosen/detailIbel/'.$data->ID_IB;?>"><button class="btn btn-primary btn-xs">Lihat Detail</button></a></td>
                        <td><a href="<?php echo base_url();?>file/laporan/<?php echo $data->FILE_IJAZAH?>" target="_blank">Lihat/Unduh</a></td>
