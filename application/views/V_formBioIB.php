        ...
        <div class="container-fluid">
          <div class="col-md-6 col-md-offset-3" >
              ...
              <div class="box box-primary" >
                ...
                <form action="<?php echo base_url().'C_dosen/BiodataIB' ?>" method="POST" enctype="multipart/form-data">
                  <div class="box-body">
                  ...
                  <div class="form-group">
                      <label for="NIDN">NIDN</label>
                        <input type="text" class="form-control" name="NIDN" placeholder="NIDN" value="<?php echo $data->NIDN ?>" required/>
                  </div>

                    <div class="form-group">
                      <label>Gelar Depan:</label>
                      <input type="text" class="form-control" name="gelardepan" placeholder="Gelar Depan" value="<?php echo $data->GELAR_DEPAN ?>"/>
                    </div><!-- /.form group -->
                    ...
                    <div class="form-group">
                      <label for="Rumpun">Gelar Belakang</label>
                        <input type="text" class="form-control" name="gelarbelakang" placeholder="Gelar Belakang" value="<?php echo $data->GELAR_BELAKANG ?>"/>
                    </div>

                    <div class="form-group">
                      <label for="Rumpun">NIP</label>
                        <input type="text" class="form-control" name="NIP" placeholder="NIP" value="<?php echo $data->NO_KTP ?>" required/>
                    </div>

                    <!-- <div class="form-group">
                      <label for="Rumpun">Unit Kerja</label>
                        <input type="text" class="form-control" name="unitker" placeholder="Unit Kerja" Value="UNAIR" />
                    </div> -->
                    ...
                    <div class="form-group">
                      ...
                      <!-- <select class="input" name="tempatlahir" id="tempatlahir">
                        ...
                        <input type="text" class="form-control" name="tempatlahir" placeholder="Tempat Lahir" value="<?php echo $data->TEMPAT_LAHIR ?>" required/>
                    </div>

                    <div class="form-group">
                      <label for="Tanggal Lahir">Tanggal Lahir</label>
                        <input type="date" class="form-control" name="tgllahir" placeholder="Tangggal Lahir" value="<?php echo $data->TGL_LAHIR ?>" required/>
                    </div>

                    <div class="form-group">
                      <label for="NoHp">No.HP</label>
                        <input type="text" class="form-control" name="nomor" placeholder="No.HP" value="<?php echo $data->HANDPHONE ?>" required/>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="golongan" id="golongan"  required>
                        ...
                        <?php } else {?>
                          <option value="<?php echo $data->PANGKAT_GOLONGAN ?>" selected><?php echo $data->PANGKAT_GOLONGAN ?></option>
                        <?php } ?>
                    ...
                    <div class="form-group">
                      <label for="TMT PNS/PT">TMT PNS/PT</label>
                        <input type="date" class="form-control" name="TMT" placeholder="TMT PNS" value="<?php echo $data->TMT_PNS ?>" required/>
                    </div>

                    <div class="form-group">
                      <label for="StatusPeg">Status Pegawai</label></br>
                      <select class="form-control" name="StatusPeg" id="StatusPeg" required>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="JenisPeg" id="JenisPeg" required>
                        ...
                        <?php } else { ?>
                          <option value="<?php echo $data->JENIS_KEPEGAWAIAN ?>" selected><?php echo $data->JENIS_KEPEGAWAIAN ?></option>
                          <?php } ?>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="StatusJab" id="StatusJab" required>
                        ...
                        <?php } else { ?>
                          <option value="<?php echo $data->STATUS_JABATAN ?>" selected><?php echo $data->STATUS_JABATAN ?></option>
                        <?php } ?>
                    ...
                    <div class="form-group">
                      <label for="Nama Jabatan">Nama Jabatan</label>
                        <input type="text" class="form-control" name="namaJab" placeholder="Nama Jabatan" value="<?php echo $data->NAMA_JABATAN ?>" required/>
                    </div>
                  ...
                  <?php } else { ?>
                    <div class="form-group">
                      <p>Foto sudah terunggah. Lihat Foto Klik <a href="<?php echo base_url().'./file/foto/'.$data->FOTO1; ?>" target="_blank"><?php echo $data->FOTO1 ?></a></p>
