                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <form role="form"
                                    action="<?php echo base_url().'C_fakultas/upload_fileTBulang/'.$id->ID_TUBEL; ?>"
                               ...
                               if(in_array($id->ID_JENIS,$ids)) { ?>
                                    ...
                                    <?php } elseif ($id->NOMOR_SURAT != NULL && $id->TGL_SURAT != NULL && $id->JABATAN_PIMPINAN == NULL || $id->NOMOR_SURAT != NULL && $id->TGL_SURAT != "0000-00-00" && $id->JABATAN_PIMPINAN == NULL) { ?>
                                    <!-- jika inputan tgl & no saja -->
                                    <td>
                                        ...
                                        <input type="date" class="form-control" name="TglSurat" placeholder="Tgl Surat"
                                            value="<?php echo $id->TGL_SURAT ?>" required><br>
                                        <input type="hidden" class="form-control" name="JabAtasan"
                                ...
                                <form role="form"
                                    action="<?php echo base_url().'C_fakultas/upload_filePanjangulang/'.$id->ID_PERPANJANGAN; ?>"
                                    method="POST" enctype="multipart/form-data" />
                                <input type="hidden" name="idjenis" value="<?php echo $id->ID_JENIS ?>">
                                ...
                                <tr>
                                    ...
                                    <?php if($id->NOMOR_SURAT != NULL && $id->TGL_SURAT != NULL && $id->JABATAN_PIMPINAN != NULL) { ?>
                                    <!-- jika upload ada inputan 3 -->
                                    <td>
                                        <input type="hidden" class="form-control" name="kode" value="1">
                                        <strong>Nomor Surat:</strong>
                                    ...
                                    <td><button type='submit' class="btn btn-primary" name="submit"
                                            value="Simpan">Simpan</button></td>
                                    <?php } elseif ($id->NOMOR_SURAT != NULL && $id->TGL_SURAT != NULL && $id->JABATAN_PIMPINAN == NULL) { ?>
                                    <!-- jika inputan tgl & no saja -->
                                    <td>
                                        <input type="hidden" class="form-control" name="kode" value="2">
                                        <strong>Nomor Surat:</strong>
                                ...
                                <form role="form"
                                    action="<?php echo base_url().'C_fakultas/upload_fileAktifulang/'.$id->ID_PENGAKTIFAN; ?>"
                                    method="POST" enctype="multipart/form-data" />
                                <input type="hidden" name="idjenis" value="<?php echo $id->ID_JENIS ?>">
                                ...
                                <form role="form"
                                    action="<?php echo base_url().'C_fakultas/upload_fileIbelulang/'.$id->ID_IB; ?>"
                                    method="POST" enctype="multipart/form-data" />
                                <input type="hidden" name="idjenis" value="<?php echo $id->ID_JENIS ?>">
