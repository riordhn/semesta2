...
$document = file_get_contents("file/template/fakultas/usulan sk pengaktifan kembali.rtf");
...
header("Content-disposition: inline; filename=Surat Permohonan SK Pengaktifan Kembali_".$nik."_".$id_tub.".doc");
