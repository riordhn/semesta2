...
if($data->JENIS_KEPEGAWAIAN == "PNS" || $data->JENIS_KEPEGAWAIAN == "Pegawai Negeri Sipil") {
	$document = file_get_contents("file/template/Baru/KEPUTUSAN REKTOR PEMBEBASAN pns.rtf");
}
else {
	$document = file_get_contents("file/template/Baru/KEPUTUSAN REKTOR PEMBEBASAN.rtf");
}
...
header("Content-disposition: inline; filename=SuratPembebasanSementara_".$nik."_".$id_tub.".doc");
