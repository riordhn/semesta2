...
$document = file_get_contents("file/template/Tubel/SURAT KETERANGAN linier.rtf");
...
header("Content-disposition: inline; filename=Surat Keterangan Linier_".$nik."_".$id_tub.".doc");
