                    ...
                    <table class="table table-striped">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>: <?php echo $data->GELAR_DEPAN ?> <?php echo $data->NAMA ?>
                                    <?php echo $data->GELAR_BELAKANG ?></td>
                            ...
                            <tr>
                                ...
                                <td style="background-color: yellow;">: <b>Semester <?php echo $data->semester_now ?>
                                        dari <?php echo $data->TOTAL_SEMESTER ?></b></td>
                            </tr>
                            <tr>
                            <tr>
                                <td><b>Jenjang</b></td>
                ...
                <div class="col-xs-12">
                    <div class="box">
                        <div class="box-header">
                            ...
                            <h5 class="box-title"><i class="fa fa-bookmark"
                                    style="font-size:24px;"></i>&nbsp;&nbsp;&nbsp;<?php if($this->session->userdata('sms')!=NULL){ ?>
                                <b>Semester <?php echo $this->session->userdata('sms');?></b>
                                <?php } else { ?><b>Silakan Pilih Semester</b><?php }?> </h5>
                        </div><!-- /.box-header --><br><br>
                        <?php if($this->session->userdata('sms')!=NULL){ ?>

                        <div class="box-body table-responsive no-padding">
                            <h4 class="box-title"><i class="fa fa-check-square-o"
                                    style="font-size:24px;"></i>&nbsp;&nbsp;&nbsp;<b>PUBLIKASI</b></h4>
                            <table class="table table-hover">
                                <?php if($this->session->userdata('sms')!=NULL){  ?>
                                <tr><?php if ($publikasi==NULL) { ?>
                                    <td width="20px"><a href="<?php echo base_url().'C_dosen/tambahPublikasiIB'?>"
                                            class="btn btn-block btn-social btn-success"><i>+</i>Tambah Laporan</a></td>
                                    <?php } ?>
                                </tr>
                                <tr><?php }?>
                                    <th>Semester</th>
                                ...
                                <tr>
                                  ...
                                  echo "<button class='btn btn-danger'/>".$publik->TGL_RENCANA."</button>"; 
                                    ...
                                    <td><?php if ($publik->BUKTI_PUBLIKASI!=NULL) { ?>
                                        <a href="<?php echo base_url().'file/monitoringIB/publikasi/'.$publik->BUKTI_PUBLIKASI; ?>"
                                            target="_blank"><button>Unduh/Lihat</button></a>
                                        <?php } ?>
                                    </td>
                                    <td align="right"><a
                                            href="<?php echo base_url().'C_dosen/editPublikasiIB/'.$publik->ID_PUBLIKASI_IB;?>"
                                            class="btn btn-warning btn-xs"><i class="fa fa-pencil">&nbsp;Koreksi</a>
                                    </td>
                                </tr>
                                <?php } ?>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <h4 class="box-title"><i class="fa fa-check-square-o"
                                    style="font-size:24px;"></i>&nbsp;&nbsp;&nbsp;<b>TOEFL</b></h4>
                            <table class="table table-hover">

                                <tr><?php if ($toef==NULL) { ?>
                                    <td width="30px"><a href="<?php echo base_url().'C_dosen/tambahToeflIB'?>"
                                            class="btn btn-block btn-social btn-success"><i>+</i>Tambah Laporan</a></td>
                                </tr>
                                <?php } ?>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  echo "<button class='btn btn-danger'/>".$toefl->tanggalber."</button>"; 
                                    ...
                                    <td><?php if ($toefl->BUKTI_TOEFL!=NULL) { ?>
                                        <a href="<?php echo base_url();?>file/monitoringIB/toefl/<?php echo $toefl->BUKTI_TOEFL ?>"
                                            target="_blank"><button>Unduh/Lihat</button></a>
                                        <?php } ?>
                                    </td>
                                    <td align="right"><a
                                            href="<?php echo base_url().'C_dosen/editToeflIB/'.$toefl->ID_TOEFL;?>"
                                            class="btn btn-warning btn-xs"><i class="fa fa-pencil">&nbsp;Koreksi</a>
                                    </td>
                                </tr>
                                <?php } ?>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <h4 class="box-title"><i class="fa fa-check-square-o"
                                    style="font-size:24px;"></i>&nbsp;&nbsp;&nbsp;<b>AKTIFITAS STUDI</b></h4>

                            <table class="table table-hover">
                                <tr><?php if ($aktifitas==NULL) { ?>
                                    <td width="30px"><a href="<?php echo base_url().'C_dosen/tambahAktifitasIB' ?>"
                                            class="btn btn-block btn-social btn-success"><i>+</i>Tambah Laporan</a></td>
                                </tr>
                                <?php } ?>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="right"><a
                                            href="<?php echo base_url().'C_dosen/editAktifitasIB/'.$aktif->ID_AKTIVITAS_IB;?>"
                                            class="btn btn-warning btn-xs"><i class="fa fa-pencil">&nbsp;Koreksi</a>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <li><b>Penjelasan Terkait<br>Kemajuan Studi</b></li>
                                    </td>
                                    <td colspan="6"><?php echo $aktif->PENJELASAN_KEMAJUAN_STUDI ?></td>
                                </tr>
                                <tr>
                                    <td>
                                        <li><b>Langkah Konkrit <br>Semester depan</b></li>
                                    </td>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <h4 class="box-title"><i class="fa fa-check-square-o"
                                    style="font-size:24px;"></i>&nbsp;&nbsp;&nbsp;<b>TUGAS AKHIR</b></h4>
                            <table class="table table-hover">

                                <tr><?php if ($tugas==NULL) {?>
                                    <td width="30px"><a href="<?php echo base_url().'C_dosen/tambahTAIB'?>"
                                            class="btn btn-block btn-social btn-success"><i>+</i>Tambah Laporan</a>
                                        <?php } ?>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><?php if ($sem->BUKTI_BIMBINGAN!=NULL) { ?>
                                        <a href="<?php echo base_url();?>file/monitoring/tugas/<?php echo $sem->BUKTI_BIMBINGAN?>"
                                            target="_blank"><button>Unduh/Lihat</button></a>
                                        <?php }else{ echo "-";} ?>
                                    </td>
                                  ...
                                  echo "<button class='btn btn-danger'/>".$sem->tanggalrensa."</button>"; 
                                    ...
                                    <td><a href="<?php echo base_url();?>file/monitoringIB/tugas/<?php echo $sem->BUKTI_SA?>"
                                            target="_blank"><button>Unduh/Lihat</button></a>
                                    </td>
                                    <td align="right"><a
                                            href="<?php echo base_url().'C_dosen/editTAIB/'.$sem->ID_TUGAS;?>"
                                            class="btn btn-warning btn-xs"><i class="fa fa-pencil">&nbsp;Koreksi</a>
                                    </td>
                                </tr>
                                <?php } ?>
