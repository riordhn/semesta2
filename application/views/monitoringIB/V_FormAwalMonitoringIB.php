          ...
          <div class="col-md-6 col-md-offset-3" >
              ...
              <div class="box box-primary" >
                <div class="box-header">
                  <center><h3 class="box-title"><b>Selamat Datang di Monitoring SEMESTA</b></h3></center>
                </div><!-- /.box-header -->
                <!-- form start -->
                <?php // foreach($Biodata as $data) { ?>
                <form action="<?php echo base_url().'C_dosen/savePenasihatIB' ?>" method="POST" enctype="multipart/form-data">
                  <div class="box-body">
                  ...
                  <div class="form-group">
                      <label>Penasehat Akademik :</label>
                        <input type="text" class="form-control" name="penasihat" placeholder="Silahkan isi disini..."/>
                  </div>
