        ...
        <div class="container-fluid">
          <div class="col-md-6 col-md-offset-3" >
              ...
              <div class="box box-primary" >
                ...
                <form action="<?php echo base_url().'C_dosen/editAktifitas' ?>" method="POST" enctype="multipart/form-data">
                  <div class="box-body">


                  <div class="form-group">
                      <!-- <label for="Rumpun">NIK</label> -->
                        <input type="Hidden" class="form-control" name="idaktif" placeholder="NIK" value="<?php echo $data->ID_AKTIVITAS;?> "/>
                  ...
                  <div class="form-group">
                      <label>SKS Kredit:</label>
                        <input type="number" class="form-control" name="sks" placeholder="SKS" value="<?php echo $data->SKS;?>" min="0" required/>
                  </div>
                    ...
                    <div class="form-group">
                      ...
                      <input type="number" class="form-control" name="persen" placeholder="Persentase Pengerjaan" value="<?php echo $data->PRESENTASE_PENGERJAAN_DISERTASI_THESIS;?>" min="0" />
                    </div>              
