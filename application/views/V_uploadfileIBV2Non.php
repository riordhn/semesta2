                        ...
                        <div class="box-body table-responsive no-padding">
                          <table class="table table-hover">
                            ...
                            <tr>
                              ...
                              <input type="hidden" name="namajenis" value="Surat Pernyataan Tidak Meninggalkan Tugas">
                              <td>1. </td>
                              <td>surat pernyataan tidak meninggalkan tugas kedinasan dan atau tugas pekerjaan sehari-hari dari yang bersangkutan (materai)</td>
                            ...
                            <form role="form" action="<?php echo base_url().'C_dosen/upload_fileIBV2/'.$id->id_ib; ?>" method="POST" enctype="multipart/form-data"/>
                              ...
                              <input type="hidden" name="namajenis" value="Bukti akreditasi prodi dan instansi minmal B">
                            <tr>
                            ...
                            <tr>
                              ...
                              <input type="hidden" name="namajenis" value="surat pernyataan biaya pendidikan ditanggung ybs">
                              <td>5. </td>
                              <td>Surat pernyataan biaya pendidikan dan fasilitas penunjang lainnya ditanggung oleh yang bersangkutan (materai), mengetahui Dekan Fak</td>
                          ...
                          <form role="form" action="<?php echo base_url().'C_dosen/upload_fileIBV2/'.$id->id_ib; ?>" method="POST" enctype="multipart/form-data"/>
                            <tr>
                              ...
                              <input type="hidden" name="namajenis" value="surat pernyataan tidak menuntut kenaikan pangkat">
                              <td>6. </td>
                              <td>Surat pernyataan tidak menuntut kenaikan pangkat penyesuian ijazah dari yang bersangkutan (materai), mengetahui Dekan Fak</td>
                          ...
                          <form role="form" action="<?php echo base_url().'C_dosen/upload_fileIBV2/'.$id->id_ib; ?>" method="POST" enctype="multipart/form-data"/>
                            <tr>
                              ...
                              <input type="hidden" name="namajenis" value="Surat Keterangan studi Linear dengan pekerjaan">
                              <td>7. </td>
                          ...
                          <form role="form" action="<?php echo base_url().'C_dosen/upload_fileIBV2/'.$id->id_ib; ?>" method="POST" enctype="multipart/form-data"/>
                            <tr>
                              ...
                              <input type="hidden" name="namajenis" value="Surat Pengantar Pengajuan Izin Belajar">
                              <td>12. </td>
                          ...
                          <div class="box box-solid box-primary">
                            ...
                            <div class="box-body">
                              ...
                              <center>Harap lengkapi seluruh dokumen diatas untuk menyelesaikan pengajuan izin belajar. Jika seluruh berkas lengkap tombol <b>SUBMIT</b> akan muncul dibawah ini. Jika masih ada berkas yang belum lengkap, anda dapat menyimpan data dengan tombol simpan dibawah.<br> </center><br><br>
                            <?php foreach ($count as $hitung) {
                              ?>
                            <div class="form-group">
                              <?php if ($hitung->jumlah<12) { ?>
                              <form action="<?php echo base_url().'C_dosen/ubahStatusIB'?>" method="post">
                              <input type="hidden" class="form-control" name="ID_tubels" value="<?php echo $id->id_ib; ?>" >
                              <input type="hidden" name="status" value="11">
                              <input type="hidden" name="jenis" value="1">
                              <center><button type="submit" class="btn btn-primary" name="btsub">Simpan</button></center>
                              </form>
                            <?php } elseif ($hitung->jumlah>=12) { ?>
                              <center><a href="<?php echo base_url().'C_dosen/SubmitIB/2/'. $id->id_ib; ?>"><button class="btn btn-success">Ajukan</button></a></center>
                            <?php }}?>
                            </div>
