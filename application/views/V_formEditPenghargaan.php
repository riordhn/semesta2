        ...
        <div class="container-fluid">
          <div class="col-md-6 col-md-offset-3" >
              ...
              <div class="box box-primary" >
                ...
                <form action="<?php echo base_url().'C_dosen/editPenghargaan' ?>" method="POST" enctype="multipart/form-data">
                  <div class="box-body">


                  <div class="form-group">
                      <!-- <label for="Rumpun">NIK</label> -->
                        <input type="Hidden" class="form-control" name="idpeng" placeholder="NIK" value="<?php echo $data->ID_PENGHARGAAN?> "/>
