                    ...
                    <div class="col-xs-12">
                      <div class="box">
                        <div class="box-header">
                          <center><h3 class="box-title">Unggah Berkas Tubel Fakultas</h3></center>
                        </div><!-- /.box-header -->
                        <?php foreach($nik as $id){ ?>
                        <form role="form" action="<?php echo base_url().'C_fakultas/upload_file/'.$id->id_tubel  ?>" method="POST" enctype="multipart/form-data">
                        <?php }?>
                      ...
                      <tr style="background-color:  #F0F0F0">
                        ...
                        <td>
                          ...
                          <input type="text" class="form-control" name="NoSuratRek" placeholder="Nomor Surat" required><br>
                          <strong>Tanggal Surat:</strong>
                          <input type="date" class="form-control" name="TglSuratRek" placeholder="Tgl Surat" required><br>
                      ...
                      <tr style="background-color:  #F0F0F0">
                        ...
                        <td>
                          <strong>Nomor Surat:</strong>
                          <input type="text" class="form-control" name="NoSuratCPNS" placeholder="Nomor Surat" required><br>
                          <strong>Tanggal Surat:</strong>
                          <input type="date" class="form-control" name="TglSuratCPNS" placeholder="Tgl Surat" required><br>
                          <strong>Jabatan Pejabat Yang bertanda Tangan:</strong>
                      ...
                      <tr>
                        <td>6.</td>
                        <td>Surat Permohonan SK Tugas Belajar dan Pembebasan Sementara dari Pimpinan Unit Kerja</td>
                        <td>
                          <strong>Nomor Surat:</strong>
                          <input type="text" class="form-control" name="NoSuratPer" placeholder="Nomor Surat" required><br>
                          <strong>Tanggal Surat:</strong>
                          <input type="date" class="form-control" name="TglSuratPer" placeholder="Tgl Surat" required><br>
                          <strong>Jabatan Pejabat Yang bertanda Tangan:</strong>
                      ...
                      <tr>
                        ...
                        <td>
                          <strong>Nomor Surat:</strong>
                          <input type="text" class="form-control" name="NoSuratPeng" placeholder="Nomor Surat" required><br>
                          <strong>Tanggal Surat:</strong>
