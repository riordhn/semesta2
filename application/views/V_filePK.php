      ...
      <div class="row">
          ...
          <div class="box">
            <table  class="table table-bordered table-striped" >
                ...
                <tbody>
                  ...
                  <td><?php  echo $data->TANGGAL_SPMT ?></td>
                </tbody>
              </table>
                 <?php } ?>
          </div>
    	<div class="box">
                <div class="box-header">
                  <center><h3 class="box-title">Daftar Berkas Pengaktifan</h3></center> <br>
                  ...
                  <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php $a=1; foreach($file as $file){ ?>
                        <tr>
                          <td><?php echo $a."."?></td>
                          <td><?php echo $file->NAMA_FILE_AKT;?></td>
                          <td><a href="<?php echo base_url();?>file/tubel/<?php echo $file->ID_UP_FILE_AKT ?>" target="_blank">Lihat/Unduh</a></td>
                        </tr>
                      <?php $a++;}?>
                    </tbody>
                  </table><br>
