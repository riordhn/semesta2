                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php if($data->ID_STATUS_SL>=2){ if($data->CEK>0){?><a href="<?php echo base_url().'C_subditSDM/prosesPengaktifanSubdit/'.$data->ID_PENGAKTIFAN;?>" class="btn btn-block btn-primary btn-sm" >Proses</a> <?php } else{if($data->NUM==0){?><a href="<?php echo base_url().'C_subditSDM/prosesPengaktifanSubdit/'.$data->ID_PENGAKTIFAN;?>" class="btn btn-block btn-primary btn-sm" >Proses</a><?php }}} ?></td>
                      </tr>
                    <?php }?>
                    </tbody>
                  </table>
