                ...
                <form action="<?php echo base_url().'C_dosen/saveBioTb' ?>" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group" <?php if($data->STATUS_PEGAWAI=='Tendik'){ echo 'style="display: none;"'; } ?> >
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" readonly="" class="form-control" name="gelardepan" placeholder="Gelar Depan" value="<?php echo $data->GELAR_DEPAN ?>"/>
                    </div><!-- /.form group -->
                    ...
                    <div class="form-group">
                      <label for="Rumpun">Gelar Belakang</label>
                        <input type="text" readonly="" class="form-control" name="gelarbelakang" placeholder="Gelar Belakang" value="<?php echo $data->GELAR_BELAKANG ?>" required/>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="Tanggal Lahir">Tanggal Lahir</label>
                        <input type="date" readonly class="form-control" name="tgllahir" placeholder="Tangggal Lahir" value="<?php echo $data->TGL_LAHIR ?>" required/>
                    </div>
                    ...
                    <div class="form-group">
                      <label for="Email">Surel</label>
                        <input type="text" readonly class="form-control" name="email" placeholder="Email" value="<?php echo $data->EMAIL ?>" required/>
                    </div>
