                        ...
                        <div class="box-body table-responsive no-padding">
                                ...
                                if ($key->FILE_B==NULL) { ?>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control" name="NoSurat"
                                            placeholder="Nomor Surat LOA" required><br>
                                        <strong>Tanggal Surat LOA:</strong>
                                        <input type="Date" class="form-control" name="TglSruat"
                                            placeholder="Tanggal Surat LOA" required><br>
                                        <strong>Unggah LOA:</strong>
                                        <input type="file" accept=".png, .jpg, .jpeg, .pdf, .bmp" class="form-control"
                            ...
                            <tr>
                              ...
                              <td><button type='submit' class="btn btn-primary" name="submit" value="Simpan">Simpan</button></td>
                                ...
                                <tr>
                                    <td>8. </td>
                                    <td>Pindaian (Scan) Paspor <br><i>*(khusus pengajuan tugas belajar luar negeri)
                                            *untuk pengajuan tugas belajar dalam negeri tidak wajib diisi</i></td>
                                    <!-- <td>-</td> -->
                                    <?php foreach ($file as $key) {
                                if ($key->FILE_M==NULL) {?>
                                    <td>Berkas belum diunggah</td>
                                ...
                                <tr>
                                    <td>9. </td>
                                    <td>Hasil SWAB PCR <br><i><strong>*Selama Pandemi COVID-19 Wajib
                                                melampirkan</strong></i></td>
                                    <!-- <td>-</td> -->
                                    <?php foreach ($file as $key) {
                                if ($key->FILE_D==NULL) {?>
                                    <td>Berkas belum diunggah</td>
                                ...
                                <tr>
                                    <td>10. </td>
                                    <td>Email/Surat dari Kedutaan <br><i><strong>*Selama Pandemi COVID-19 Wajib
                                                melampirkan</strong></i></td>
                                    <!-- <td>-</td> -->
                                    <?php foreach ($file as $key) {
                                if ($key->FILE_E==NULL) {?>
                                ...
                                <tr>
                                    <td>11. </td>
                                    <td>Agenda Kegiatan selama Studi <br><i><strong>*Selama Pandemi COVID-19 Wajib
                                                melampirkan</strong></i></td>
                                    <!-- <td>-</td> -->
                                    <?php foreach ($file as $key) {
                                if ($key->FILE_G==NULL) {?>
                                ...
                                if ($key->FILE_N==NULL) {?>
                                    ...
                                    <td><strong>Nomor Surat:</strong>
                                        ...
                                        <input type="date" class="form-control" name="TglSurat" placeholder="Tgl Surat"
                                            required><br>
                                        <strong>Jabatan Pejabat Yang bertanda Tangan:</strong>
                                        <input type="text" class="form-control" name="JabAtasan"
                                ...
                                <tr>
                                    <td>17. </td>
                                    <td>Surat Permohonan SK Tugas Belajar dan Pembebasan Sementara dari Pimpinan Unit
                                        Kerja</i></td>
                                    <!-- <td>-</td> -->
                                    <?php foreach ($file as $key) {
                                if ($key->FILE_S==NULL) {?>
                                ...
                                <tr>
                                    <td>18. </td>
                                    <td>Surat keterangan dari pimpinan unit kerja mengenai bidang studi yang akan
                                        ditempuh mempunyai hubungan atau sesuai dengan tugas pekerjaannya (ttd. Kedep &
                                        Mengetahui Dekan Fak)</i></td>
                                    <!-- <td>-</td> -->
                                    <?php foreach ($file as $key) {
                                if ($key->FILE_T==NULL) {?>
                                    <td>Berkas belum diunggah</td>
                                ...
                                <tr>
                                    <td>20. </td>
                                    <td>Kartu Pegawai / ID Card (untuk PT) <br><i>*diharapkan untuk bisa mengunggah
                                            karpeg/ID Card</i></td>
                                    <!-- <td>-</td> -->
                                    <?php foreach ($file as $key) {
                                if ($key->FILE_V==NULL) {?>
                                ...
                                <tr>
                                    <td>21. </td>
                                    <td>Konversi NIP <br><i><strong>*Tidak Wajib</strong>, Jika ada maka silahkan
                                            diunggah</i></td>
                                    <!-- <td>-</td> -->
                                    <?php foreach ($file as $key) {
                                if ($key->FILE_W==NULL) {?>
                            ...
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <center>
                                        <h3 class="box-title">Konfirmasi data Tugas Belajar</h3>
                                    </center>
                                </div>
                                <div class="box-body">

                                    <center>Harap lengkapi seluruh dokumen diatas untuk menyelesaikan pengajuan tugas
                                        belajar. Pilihan <b>AJUKAN</b> akan muncul apabila unggahan berkas lengkap
                                        Konfirmasi data tugas belajar. Jika masih ada berkas yang belum lengkap, anda
                                        dapat menyimpan data dengan tombol simpan dibawah.<br> </center><br><br>
                          ...
                          if ($count==19 && $k->FILE_M==NULL && $k->FILE_I==NULL && $k->FILE_W==NULL || $count==22 && $k->FILE_M!=NULL && $k->FILE_I!=NULL && $k->FILE_W!=NULL || $count==21 && $k->FILE_M==NULL && $k->FILE_I!=NULL && $k->FILE_W!=NULL || $count==21 && $k->FILE_M!=NULL && $k->FILE_I==NULL && $k->FILE_W!=NULL || $count==21 && $k->FILE_M!=NULL && $k->FILE_I!=NULL && $k->FILE_W==NULL || $count==20 && $k->FILE_M!=NULL && $k->FILE_I==NULL && $k->FILE_W==NULL || $count==20 && $k->FILE_M==NULL && $k->FILE_I!=NULL && $k->FILE_W==NULL || $count==20 && $k->FILE_M==NULL && $k->FILE_I==NULL && $k->FILE_W!=NULL) { ?>
                                        ...
                                        <br>
                                        <center><a
                                                href="<?php echo base_url().'C_dosen/SubmitTB/2/'. $id->id_tubel; ?>"><button
