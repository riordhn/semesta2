      ...
      <div class="row">
    	...
    	<div class="box">
                <div class="box-header">
                  <center><h3 class="box-title">Daftar Berkas Tugas Belajar</h3></center> <br>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table class="table table-bordered table-striped">
                    <thead>
                    ...
                    <tbody>
                      <?php $a=1; foreach($file as $file){ ?>
                        <tr>
                          ...
                          <td><a href="<?php echo base_url();?>file/tubel/<?php echo $file->ID_UP_FILE_T?>" target="_blank">Lihat/Unduh</a></td>
                        </tr>
                      <?php $a++;}?>
                    </tbody>
                  </table><br>
