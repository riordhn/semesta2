            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  ...
                  <h3 class="box-title">Monitoring Izin Belajar</h3><br><br>
                  <td width="30%">
                        ...
                        <a href="<?php echo base_url().'C_dosen/tabelMonitorinIBDosen/'.'$_POST[semester]' ?>"><button>Pilih</button></a>
                        </form>
                      </td><br><br>
                ...
                <div class="box-body table-responsive no-padding">
                  ...
                  <table class="table table-hover">
                    <?php if($this->session->userdata('sms')!=NULL){ 
                      if(empty($aktifitas)){  ?>
                    <tr><td width="30px"><a href="<?php echo base_url().'C_dosen/tambahAktifitasIB' ?>" class="btn btn-block btn-social btn-instagram"><i>+</i>Tambah Aktifitas </a></td></tr>
                   <?php } else {
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo base_url().'C_dosen/editAktifitasIB/'.$aktif->ID_AKTIVITAS_IB;?>" class="btn btn-warning btn-xs" >Koreksi</a></td>
                   </tr>
                   <?php  $a++;} ?>
                  <?php //} ?>
                ...
                <div class="box-body table-responsive no-padding">
                  ...
                  <table class="table table-hover">
                    <?php if($this->session->userdata('sms')!=NULL){  ?>
                    <tr><td width="30px"><a href="<?php echo base_url().'C_dosen/tambahPublikasiIB'?>" class="btn btn-block btn-social btn-instagram"><i>+</i>Tambah Publikasi </a></td></tr>
                    <tr><?php }?>
                      <th>No.</th>
                      <th>Judul Jurnal</th>
                      <th>ISSN/ISBN</th>
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo base_url().'C_dosen/editPublikasi/'.$publik->ID_PUBLIKASI_IB;?>" class="btn btn-warning btn-xs" >Koreksi</a></td>
                   </tr>
                  <?php $s++;} ?>
                ...
                <div class="box-body table-responsive no-padding">
                  ...
                  <table class="table table-hover">
                    ...
                    <tr><td width="30px"><a href="<?php echo base_url().'C_dosen/tambahPenghargaanIB'?>" class="btn btn-block btn-social btn-instagram"><i>+</i>Tambah Penghargaan </a></td></tr>
                    <tr>
                      <th>No.</th>
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo base_url().'C_dosen/editPenghargaan/'.$peng->ID_PENGHARGAAN_IB;?>" class="btn btn-warning btn-xs" >Koreksi</a></td>
                   </tr>
                  <?php $d++;} ?>
                 ...
                 <div class="box-body table-responsive no-padding">
                  ...
                  <table class="table table-hover">
                    ...
                    <tr><td width="30px"><a href="<?php echo base_url().'C_dosen/tambahSeminarIB'?>" class="btn btn-block btn-social btn-instagram"><i>+</i>Tambah Kegiatan</a></td></tr>
                    <tr>
                      <th>No.</th>
                      <th>Nama Kegiatan</th>
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo base_url().'C_dosen/editSeminar/'.$sem->ID_KEGIATAN_IB;?>" class="btn btn-warning btn-xs" >Koreksi</a></td>
                   </tr>
                  <?php $f++;} ?>
