                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                <tr>
                                    ...
                                    <th colspan="2">Unggah(format PDF/image, maks. 5 MB)</th>
                                </tr>
                                ...
                                if ($key->FILE_B==NULL) { ?>
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control" name="NoLOA"
                                            placeholder="Nomor Surat LOA" required><br>
                                        <strong>Tanggal Surat LOA:</strong>
                                        <input type="Date" class="form-control" name="TglLOA"
                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        if ($count >= 7 && $k->FILE_A != NULL && $k->FILE_B != NULL && $k->FILE_C != NULL && $k->FILE_F != NULL && $k->FILE_K != NULL && $k->FILE_L != NULL && $k->FILE_M != NULL) { ?>
                                        ...
                                        <br>
                                        <center><a
                                                href="<?php echo base_url().'C_dosen/SubmitTB/1/'. $id->id_tubel; ?>"><button
