                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <form role="form" action="<?php echo base_url().'C_Age/uploadfile_setneg/'.$data->ID_TUBEL;?>"class="form-group" method="POST" enctype="multipart/form-data">
                          <td>
                             ...
                             <label>Tanggal & Nomor SETNEG</label><br>
                              ...
                              <label>File SETNEG</label>
                              <input type="file" accept=".png, .jpg, .jpeg, .pdf, .bmp" class="form-control" name="<?php echo $data->ID_TUBEL;?>"> <br>
                          </td>
