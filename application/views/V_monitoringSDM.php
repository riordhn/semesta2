         ...
         <div class="row">
             <div class="col-lg-2 col-xs-6">
                 ...
                 <div class="small-box bg-aqua">
                     ...
                     <a href="<?php echo base_url().'C_subditSDM/detailMonitoring/1' ?>" class="small-box-footer">Lihat
             ...
             <div class="col-lg-2 col-xs-6">
                 ...
                 <div class="small-box bg-green">
                     ...
                     <a href="<?php echo base_url().'C_subditSDM/detailMonitoring/2' ?>" class="small-box-footer">Lihat
                         Detail <i class="fa fa-arrow-circle-right"></i></a>
                 </div>
             </div><!-- ./col -->
             <div class="col-lg-2 col-xs-6">
                 ...
                 <div class="small-box bg-yellow">
                     ...
                     <a href="<?php echo base_url().'C_subditSDM/detailMonitoring/3' ?>" class="small-box-footer">Lihat
                         Detail <i class="fa fa-arrow-circle-right"></i></a>
                 </div>
             </div><!-- ./col -->
             <div class="col-lg-2 col-xs-6">
                 ...
                 <div class="small-box bg-red">
                     ...
                     <a href="<?php echo base_url().'C_subditSDM/detailMonitoring/4' ?>" class="small-box-footer">Lihat
                         Detail <i class="fa fa-arrow-circle-right"></i></a>
                 </div>
             </div><!-- ./col -->
             <div class="col-lg-2 col-xs-6">
                 ...
                 <div class="small-box bg-blue">
                     ...
                     <a href="<?php echo base_url().'C_subditSDM/detailMonitoring/5' ?>" class="small-box-footer">Lihat
                         Detail <i class="fa fa-arrow-circle-right"></i></a>
                 </div>
             </div><!-- ./col -->
             <div class="col-lg-2 col-xs-6">
                 ...
                 <div class="small-box bg-purple">
                     ...
                     <a href="<?php echo base_url().'C_subditSDM/detailMonitoring/6' ?>" class="small-box-footer">Lihat
                         Detail <i class="fa fa-arrow-circle-right"></i></a>
                 </div>
             </div><!-- ./col -->
         </div><!-- /.row -->
         ...
         <div class="row">
             ...
             <div class="col-lg-2 col-xs-6">
                 ...
                 <div class="small-box bg-teal">
                     ...
                     <a href="<?php echo base_url().'C_subditSDM/detailMonitoringSmt7' ?>"
             ...
             <div class="col-lg-2 col-xs-6">
                 ...
                 <div class="small-box bg-maroon">
                     <div class="inner">
                         ...
                         <p>
                             Total Aktif Tugas Belajar
                         </p>
                     </div>
                     <div class="icon">
                         <i class="fa fa-fw fa-group"></i>
                     </div>
                     <a href="<?php echo base_url().'C_subditSDM/detailMonitoringSemua/' ?>"
                         class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
                 </div>
             </div><!-- ./col -->
             <div class="col-lg-2 col-xs-6">
                 ...
                 <div class="small-box bg-green">
                     ...
                     <a href="<?php echo base_url().'C_subditSDM/detailMonitoringTh/' ?>" class="small-box-footer">Lihat
                         Detail <i class="fa fa-arrow-circle-right"></i></a>
                 </div>
             </div><!-- ./col -->
             <div class="col-lg-2 col-lg-6 ">
                 ...
                 <div class="small-box bg-navy">
                     ...
                     <a href="<?php echo base_url().'C_subditSDM/detailMonitoringIndi/' ?>"
                         class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
                 </div>
             </div><!-- ./col -->
             <div class="col-lg-2 col-xs-6">
                 ...
                 <div class="small-box bg-green">
                     ...
                     <a href="<?php echo base_url().'C_subditSDM/detailMonitoringLulus/' ?>"
                         class="small-box-footer">Lihat Detail <i class="fa fa-arrow-circle-right"></i></a>
                 </div>
             </div><!-- ./col -->
                 ...
                 <div class="box-body">
                     <table id="example1" class="table table-bordered table-striped">
                         <thead>
                             <tr>
                                 <th colspan="8"></th>
                                 <th><a href="<?php echo base_url().'C_subditSDM/fileExcel/';?>"
                         ...
                         <tbody>
                             ...
                             <tr>
                                 ...
                                 <td><a href="<?php echo base_url().'C_subditSDM/detailMonevSDM/'.$akt->a;?>"
