           ...
           <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="<?php echo base_url().'C_fakultas/usulanTBFakultas' ?>">Usulan Tugas Belajar</a></li>
                  <li><a href="<?php echo base_url().'C_fakultas/usulanPerpanjangan' ?>">Perpanjangan Tugas Belajar</a></li>
                  <li><a href="<?php echo base_url().'C_fakultas/usulanPengaktifan' ?>">Pengaktifan Kembali Tugas Belajar</a></li>
                </ul>
              </li>
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Izin Belajar <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
                  <li><a href="<?php echo base_url().'C_fakultas/usulanIBFakultas' ?>"> Usulan Izin Belajar</a></li>  
                 <!--  <li><a href="<?php echo base_url().'C_fakultas/usulanPerpanjanganIB' ?>">Perpanjangan Izin Belajar</a></li> -->
                  <li><a href="<?php echo base_url().'C_fakultas/usulanLaporanIB' ?>">Laporan Selesai Izin Belajar</a></li>
                </ul>
              </li>
              <li><a href="<?php echo base_url().'C_fakultas/dokumenSetnegFak' ?>">Dokumen SETNEG</a></li> 
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="<?php echo base_url().'C_fakultas/riwayatFakultas' ?>">Arsip Pengajuan Tugas Belajar</a></li>
                  <li><a href="<?php echo base_url().'C_fakultas/riwayatFakultasIB' ?>">Arsip Pengajuan Izin Belajar</a></li>
                </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li><a href="<?php echo base_url().'C_fakultas';?>" class="navbar-brand">Hai, Admin <?php echo $this->session->userdata('fak'); ?>!</a></li>
