      ...
      <div class="row">
         <center><h3 class="box-title">Data Tugas Belajar</h3></center> <br>
          ...
          <div class="box">
            <table  class="table table-bordered table-striped" >
                <thead>
                  <th>Perguruan Tinggi <br> Nama Bidang <br> Negara</th>
                  <th>Jenjang</th>
                  <th>Tanggal Mulai TB</th>
                  <th>Tanggal Selesai TB</th>
                  <th>Sumber Pembiayaan <br> Tahun Pembiayaan</th>
                   <th>Tanggal Mulai Perpanjangan</th>
                  <th>Tanggal Selesai Perpanjangan</th>
                  <th>Tambahan Semester</th>
                </thead>
                <tbody>
                  <td><?php echo $data->PERGURUAN_TINGGI_PENYELENGGARA."<br>".$data->NAMA_BIDANG_PERGURUAN_TINGGI."<br>".$data->NAMA_NEGARA?></td>
                  <td><?php  echo $data->ID_JENJANG ?></td>
                  <td><?php  echo $data->MULAI_TUBEL ?></td>
                  <td><?php  echo $data->SELESAI_TUBEL ?></td>
                  <td><?php  echo $data->SUMBER_PEMBIAYAAN."<br>".$data->TAHUN_PEMBIAYAAN ?></td>
                  <td><?php  echo $data->MULAI_PERPANJANGAN ?></td>
                  <td><?php  echo $data->SELESAI_PERPANJANGAN ?></td>
                  <td><?php  echo $data->TAMBAHAN_SEMESTER ?></td>
                </tbody>
              </table>
                 <?php } ?>
          </div>
    	<div class="box">
                <div class="box-header">
                  <center><h3 class="box-title">Daftar Berkas Perpanjangan</h3></center> <br>
                  ...
                  <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                      <?php $a=1; foreach($file as $file){ ?>
                        <tr>
                          <td><?php echo $a."."?></td>
                          <td><?php echo $file->NAMA_FILE_PJG;?></td>
                          <td><a href="<?php echo base_url();?>file/perpanjangan/<?php echo $file->ID_UP_FILE_PJG ?>" target="_blank">Lihat/Unduh</a></td>
                        </tr>
                      <?php $a++;}?>
                    </tbody>
                  </table><br>
