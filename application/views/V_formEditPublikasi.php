        ...
        <div class="container-fluid">
          <div class="col-md-6 col-md-offset-3" >
              ...
              <div class="box box-primary" >
                ...
                <form action="<?php echo base_url().'C_dosen/editPublikasi' ?>" method="POST" enctype="multipart/form-data">
              <div class="box-body">
                  ...
                  <div class="form-group">
                      <!-- <label for="Rumpun">NIK</label> -->
                       <input type="Hidden" class="form-control" name="idpublik" placeholder="NIK" value="<?php echo $data->ID_PUBLIKASI;?> "/>
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      <label for="Sektor">Indeks Shinta :</label><br>
                      <select name="shinta" id="shinta">
                         <option >----Pilih Indeks----</option>
                         <option value="Shinta 1">Shinta 1</option>
                         <option value="Shinta 2">Shinta 2</option>
                         <option value="Shinta 3">Shinta 3</option>
                         <option value="Shinta 4">Shinta 4</option>
                         <option value="Shinta 5">Shinta 5</option>
                         <option value="Shinta 6">Shinta 6</option>

                      </select>
                    </div>

                    <div class="form-group">
                      <label for="Sektor">Tahun Publikasi :</label>
