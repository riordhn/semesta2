        ...
        <div class="box">
            ...
            <div class="box-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td colspan="5">Langkah Konkrit Semester Depan: <?php echo $akt->LANGKAH_KONKRIT_SMT_DEPAN; ?>
                        </td>
                    </tr>
                    <?php } ?>
                </table>
            ...
            <div class="box-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo base_url();?>file/<?php echo $jenis_monitoring;?>/publikasi/<?php echo $pub->BUKTI_PUBLIKASI; ?>"
            ...
            <div class="box-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td><a href="<?php echo base_url();?>file/<?php echo $jenis_monitoring;?>/toefl/<?php echo $peng->BUKTI_TOEFL; ?>"
                                target="_blank">Lihat</a></td>
                        <td>-</td>
                        <?php }else{ ?>
                        <td>Belum</td>
            ...
            <div class="box-body">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td colspan="4"><a
                                href="<?php echo base_url();?>file/<?php echo $jenis_monitoring;?>/tugas/<?php echo $sem->BUKTI_BIMBINGAN; ?>"
                                target="_blank">Lihat</a></td>
                    </tr>
                    <tr>
