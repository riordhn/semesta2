    ...
    <div class="container-fluid">
    	 <div class="box"> 
                <div class="box-header">
                  <center><h3 class="box-title">Arsip Pengajuan Tugas Belajar</h3></center> <br>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><a href="<?php echo base_url().'C_subditSDM/fileTBSubdit/'.$data->ID_TUBEL;?>" class="btn btn-block btn-primary btn-sm" >Lihat Berkas</a></td>
                      </tr>
                       <?php } ?>
                    </tbody>
                  </table>
