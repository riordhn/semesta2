    ...
    <div class="container-fluid">
    	 <div class="box"> 
                <div class="box-header">
                  <center><h3 class="box-title">Arsip Pengajuan Pengaktifan Tugas Belajar</h3></center> <br>
                </div><!-- /.box-header -->
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $data->TANGGAL_SUBMIT_PK ?></td>
                        <td><?php echo $data->STATUS_SL?></td>
                        <td><?php echo $data->LOKASI_DATA?></td>
                          <td><a href="<?php echo base_url().'C_subditSDM/filePKSubdit/'.$data->ID_PENGAKTIFAN;?>" class="btn btn-block btn-primary btn-sm" >Lihat Berkas</a></td>
                      </tr>
                       <?php } ?>
                    </tbody>
                  </table>
