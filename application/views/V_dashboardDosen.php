...
<section class="invoice">
          ...
          <div class="alert alert-warning alert-dismissable">
              ...
              <h4><i class="icon fa fa-warning"></i> Perhatian!</h4>
                    Ada File Pengajuan yang ditangguhkan! Silakan <a href="<?php echo base_url().'C_dosen/fileDitangguhkan' ?>" class="btn btn-primary btn-xs">Klik di sini</a> untuk upload ulang!
          </div>
        <?php } 
            ...
            <h4><i class="icon fa fa-warning"></i> PERHATIAN!</h4>
            Anda sekarang berada di semester <b><?php echo $this->session->userdata('semontb');?></b> dari <b><?php echo $this->session->userdata('setaltb');?></b> Tugas Belajar, diharapkan mengisi monitoring semester <?php echo $this->session->userdata('semontb');?> disini <a href="<?php echo base_url().'C_dosen/cekMonitoring' ?>" class="btn btn-primary btn-xs">Klik Disini</a>
          </div>
           ...
           if (!empty($this->session->userdata('cekib'))) { ?>
            ...
            <!-- <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> -->
            <h4><i class="icon fa fa-warning"></i> PERHATIAN!</h4>
            Anda sekarang berada di semester <b><?php echo $this->session->userdata('semonib');?> </b> dari <b><?php echo $this->session->userdata('setalib');?></b> Izin Belajar, diharapkan mengisi monitoring semester <?php echo $this->session->userdata('semonib');?> disini <a href="<?php echo base_url().'C_dosen/cekMonitoringIB' ?>" class="btn btn-primary btn-xs">Klik Disini</a>
          </div>
           <?php } ?>
          ...
          <div class="alert alert-danger alert-dismissable">
            <!-- <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> -->
            <h4><i class="icon fa fa-warning"></i> PERHATIAN!</h4>
            Anda sudah memasuki semester 5. Jika anda memerlukan perpanjangan silahkan <a href="<?php echo base_url().'C_dosen/formPerpanjangan' ?>" class="btn btn-primary btn-xs">Klik Disini</a> untuk mengajukan perpanjangan studi lanjut
          </div>
        <?php }} ?>
          <div class="row">
            <div class="col-xs-12">
