        ...
        <section id="contact" class="contact">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <form id="w0" class="php-email-form" action="<?php echo base_url().'C_loginStaff/authadmin';?>"
                            method="post">
                            <div class="row">
                            ...
                            <br>
                            <center> Dosen/Tenaga Kependidikan masuk<a href="<?php echo base_url().'C_loginDosen/'?>">
                                    disini</a></center>
                        </form>
                        <br>
