                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table class="table table-hover">
                                ...
                                <tr><?php if ($publikasi==NULL) { ?>
                                    <td width="20px"><a href="<?php echo base_url().'C_dosen/tambahPublikasi'?>"
                                ...
                                <tr>
                                  ...
                                  echo "<button class='btn btn-danger'/>".$publik->TGL_RENCANA."</button>"; 
                                    ...
                                    <td><?php if ($publik->BUKTI_PUBLIKASI!=NULL) { ?>
                                        <a href="<?php echo base_url().'file/monitoring/publikasi/'.$publik->BUKTI_PUBLIKASI; ?>"
                                            target="_blank"><button>Unduh/Lihat</button></a>
                                        <?php } ?>
                                    </td>
                                    <td align="right"><a
                                            href="<?php echo base_url().'C_dosen/editPublikasi/'.$publik->ID_PUBLIKASI;?>"
                                            class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i>&nbsp;Koreksi</a>
                                    </td>
                                </tr>
                                <?php } ?>
                        ...
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table class="table table-hover">
                                ...
                                <tr><?php if ($toef==NULL) { ?>
                                    <td width="30px"><a href="<?php echo base_url().'C_dosen/tambahToefl'?>"
                                            class="btn btn-block btn-social btn-success"><i>+</i>Tambah Laporan</a></td>
                                </tr>
                                <?php } ?>
                                <tr>
                                ...
                                <tr>
                                  ...
                                  echo "<button class='btn btn-danger'/>".$toefl->tanggalber."</button>"; 
                                    ...
                                    <td><?php if ($toefl->BUKTI_TOEFL!=NULL) { ?>
                                        <a href="<?php echo base_url();?>file/monitoring/toefl/<?php echo $toefl->BUKTI_TOEFL ?>"
                                            target="_blank"><button>Unduh/Lihat</button></a>
                                        <?php } ?>
                                    </td>
                                    <td align="right"><a
                                            href="<?php echo base_url().'C_dosen/editToefl/'.$toefl->ID_TOEFL;?>"
                                            class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i>&nbsp;Koreksi</a>
                                    </td>
                                </tr>
                                <?php } ?>
                        ...
                        <div class="box-body table-responsive no-padding">
                            <h4 class="box-title"><i class="fa fa-check-square-o"
                                    style="font-size:24px;"></i>&nbsp;&nbsp;&nbsp;<b>AKTIVITAS STUDI</b></h4>

                            <table class="table table-hover">
                                <tr><?php if ($aktifitas==NULL) { ?>
                                    <td width="30px"><a href="<?php echo base_url().'C_dosen/tambahAktifitas' ?>"
                                            class="btn btn-block btn-social btn-success"><i>+</i>Tambah Laporan</a></td>
                                </tr>
                                <?php } ?>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td align="right"><a
                                            href="<?php echo base_url().'C_dosen/editAktifitas/'.$aktif->ID_AKTIVITAS;?>"
                                            class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i>&nbsp;Koreksi</a>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <div class="box-body table-responsive no-padding">
                            ...
                            <table class="table table-hover">
                                ...
                                <tr><?php if ($tugas==NULL) {?>
                                    <td width="30px"><a href="<?php echo base_url().'C_dosen/tambahTA'?>"
                                ...
                                <tr>
                                  ...
                                  echo "<button class='btn btn-danger'/>".$sem->tanggalrensa."</button>"; 
                                    ...
                                    <td><?php if ($sem->SEMINAR_AKHIR==1) { ?>
                                        <a href="<?php echo base_url();?>file/monitoring/tugas/<?php echo $sem->BUKTI_SA?>"
                                            target="_blank"><button>Unduh/Lihat</button></a>
                                        <?php }else { 
                          echo "Belum";}?>
                                    </td>
                                    <td align="right"><a
                                            href="<?php echo base_url().'C_dosen/editTA/'.$sem->ID_TUGAS;?>"
                                            class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i>&nbsp;Koreksi</a>
                                    </td>
                                </tr>
                                <?php } ?>
