        ...
        <div class="container-fluid">
          <div class="col-md-6 col-md-offset-3" >
              ...
              <div class="box box-primary" >
                ...
                <form action="<?php echo base_url().'C_dosen/saveAktifitas2' ?>" method="POST" enctype="multipart/form-data">
                  <div class="box-body">
                  ...
                  <div class="form-group">
                      <label>Promotor I / Dosbing I:</label>
                        <input type="text" class="form-control" name="dos1" placeholder="Ketik disini..."required />
                  </div>

                    <div class="form-group">
                      <label>Promotor II / Dosbing II:</label>
                      <input type="text" class="form-control" name="dos2" placeholder="Ketik disini..." required />
                    </div><!-- /.form group -->

                    <div class="form-group">
                      <label>Topik:</label>
                      <input type="text" class="form-control" name="topik" placeholder="Topik" required /><br>
                      <i>*Jika belum ada topik silahkan isi dengan " - "</i>
                    </div>

                    <div class="form-group">
                      <label>Persentase Tugas Akhir/Thesis ( % ):</label>
                      <input type="number" class="form-control" name="persenta" placeholder="Contoh: 20%" min="0" required />
                      <i>*note:</i>
                    </div>

                    <div class="form-group">
                      <label>Persentase Kelulusan ( % ):</label>
                      <input type="number" class="form-control" name="persenkel" placeholder="Contoh: 20%" min="0" required />
                      <i>*note:</i>
                    </div>                 
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="kemajuan" class="form-control" id="kemajuan" rows="4" cols="80" placeholder="Tulis Disini...." required></textarea>
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="langkah" class="form-control" id="langkah" rows="4" cols="80" placeholder="Tulis Disini...." required></textarea>
                    </div>
