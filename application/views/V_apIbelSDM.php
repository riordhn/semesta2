    ...
    <div class="container-fluid">
    	 <div class="box"> 
                <div class="box-header">
                  <center><h3 class="box-title">Arsip Pengajuan Izin Belajar</h3></center> <br>
                </div><!-- /.box-header -->
                <div class="box-body">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td><?php echo $data->LOKASI_DATA?></td>
                         <td><a href="<?php echo base_url().'C_subditSDM/fileIBSubdit/'.$data->ID_IB;?>" class="btn btn-block btn-primary btn-sm" >Lihat Berkas</a></td>
                      </tr>
                       <?php } ?>
                    </tbody>
                  </table>
