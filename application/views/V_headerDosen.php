        ...
        <nav class="navbar navbar-static-top">
          ...
          <div class="collapse navbar-collapse" id="navbar-collapse">
            <ul class="nav navbar-nav">
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="<?php echo base_url().'C_dosen/formtb' ?>">Pendaftaran Tugas Belajar</a></li>
                  <li><a href="<?php echo base_url().'C_dosen/cekMonitoring' ?>">Monitoring</a></li>
                  <li><a href="<?php echo base_url().'C_dosen/formPerpanjangan' ?>">Perpanjangan Tugas Belajar</a></li>
                  <li><a href="<?php echo base_url().'C_dosen/formPengaktifan' ?>">Pengaktifan Kembali Tugas Belajar</a></li>
                </ul>
              </li>
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Izin Belajar <span class="caret"></span></a>
                <ul class="dropdown-menu" role="menu">
                  <li><a href="<?php echo base_url().'C_dosen/formBioIb' ?>"> Pendaftaran Izin Belajar</a></li>
                  ...
                  <li><a href="<?php echo base_url().'C_dosen/formLaporan' ?>">Laporan Selesai Izin Belajar</a></li>
                </ul>
              </li>
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="<?php echo base_url().'C_dosen/riwayatDosen' ?>">Arsip Pengajuan Tugas Belajar</a></li>
                  <li><a href="<?php echo base_url().'C_dosen/riwayatDosenIB' ?>">Arsip Pengajuan Izin Belajar</a></li>
            ...
            <ul class="nav navbar-nav navbar-right">
              <li><a href="<?php echo base_url().'C_dosen';?>" class="navbar-brand">Hai, <?php echo $this->session->userdata('name');?></a></li>
              <li><a href="<?php echo base_url().'C_loginDosen/logout';?>" class="navbar-brand">Keluar</a></li>
            </ul>
          </div><!-- /.navbar-collapse -->
          </div><!-- /.container-fluid -->
        </nav>
